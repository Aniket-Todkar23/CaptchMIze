...
export function ScratchCaptcha({ onVerify }: { onVerify: (isHuman: boolean) => void }) {
  ...
  const calculateCoverage = (ctx: CanvasRenderingContext2D): number => {
